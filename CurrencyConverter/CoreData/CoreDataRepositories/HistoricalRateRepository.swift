...
//        let datePredicate = NSPredicate(format: "%K == %D", #keyPath(CDBulletin.date), date as CVarArg)
//        let numberPredicate = NSPredicate(format: "%K == %D", #keyPath(CDExchangeRate.currencyNumber), currency.number)
