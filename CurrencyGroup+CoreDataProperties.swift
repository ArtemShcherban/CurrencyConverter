//
//  CurrencyGroup+CoreDataProperties.swift
//  CurrencyConverter
//
...
extension CurrencyGroup {
    ...
    @nonobjc public class func fetchRequest() -> NSFetchRequest<CurrencyGroup> {
        return NSFetchRequest<CurrencyGroup>(entityName: "CurrencyGroup")
    }
...
extension CurrencyGroup : Identifiable {
